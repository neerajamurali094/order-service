...
import com.diviso.graeshoppe.order.client.customer.model.CustomerDTO;
...
public interface CustomerResourceApi {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/customers/findbyreference/{reference}",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<Customer> findbyreferenceUsingGET(@NotNull @ApiParam(value = "reference", required = true) @Valid @RequestParam(value = "reference", required = true) String reference);
